...
MAP = {
    ...
    "Preface": "Önsöz",
    "Chapter 0 - Inference": "Bölüm 0 - Çıkarım",
    "Chapter 1 - Prerequisites": "Bölüm 1 - Ön Koşullar",
    ...
    "Chapter 2 - Models": "Bölüm 2 - Modeller",
    ...
    "Chapter 3 - Hardware": "Bölüm 3 - Donanım",
    ...
    "Chapter 4 - Software": "Bölüm 4 - Yazılım",
    "4.1   CUDA": "4.1   CUDA",
    ...
    "Chapter 5 - Techniques": "Bölüm 5 - Teknikler",
    ...
    "Chapter 6 - Modalities": "Bölüm 6 - Modaliteler",
    ...
    "Chapter 7 - Production": "Bölüm 7 - Prodüksiyon",
    ...
    "Appendix A - Inference Glossary": "Ek A - Çıkarım Sözlüğü",
    "Appendix B - Recommended Reading": "Ek B - Önerilen Okumalar",
    "Architecture": "Mimari",
    "Developer Tools": "Geliştirici Araçları",
    "Frontier Open Models": "Öncü Açık Modeller",
    "GPU Infrastructure": "GPU Altyapısı",
    "Inference Optimization Research": "Çıkarım Optimizasyonu Araştırmaları",
    "Intelligence Evaluation": "Zeka Değerlendirmesi",
...
for fname in FILES:
    ...
    with open(path, encoding="utf-8") as f:
        content = f.read()
    # replace longest strings first to avoid partial-prefix collisions
    for key in sorted(MAP, key=len, reverse=True):
        content = content.replace(f">{key}<", f">{MAP[key]}<")
    content = content.replace('lang="en-US"', 'lang="tr-TR"')
    content = content.replace('xml:lang="en-US"', 'xml:lang="tr-TR"')
